function varargout = IntrinsicLooper(varargin)
% INTRINSICLOOPER M-file for IntrinsicLooper.fig
%      INTRINSICLOOPER, by itself, creates a new INTRINSICLOOPER or raises the existing
%      singleton*.
%
%      H = INTRINSICLOOPER returns the handle to a new INTRINSICLOOPER or the handle to
%      the existing singleton*.
%
%      INTRINSICLOOPER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in INTRINSICLOOPER.M with the given input arguments.
%
%      INTRINSICLOOPER('Property','Value',...) creates a new INTRINSICLOOPER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before IntrinsicLooper_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to IntrinsicLooper_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help IntrinsicLooper

% Last Modified by GUIDE v2.5 15-Jul-2014 13:55:37

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @IntrinsicLooper_OpeningFcn, ...
                   'gui_OutputFcn',  @IntrinsicLooper_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before IntrinsicLooper is made visible.
function IntrinsicLooper_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to IntrinsicLooper (see VARARGIN)

% Choose default command line output for IntrinsicLooper
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes IntrinsicLooper wait for user response (see UIRESUME)
...
function varargout = IntrinsicLooper_OutputFcn(hObject, eventdata, handles) 
...
function trialInterval_Callback(hObject, eventdata, handles)
% hObject    handle to trialInterval (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of trialInterval as text
%        str2double(get(hObject,'String')) returns contents of trialInterval as a double


% --- Executes during object creation, after setting all properties.
function trialInterval_CreateFcn(hObject, eventdata, handles)
% hObject    handle to trialInterval (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
