function out = cameraconfigcode
%CAMERACONFIGCODE Code for creating a video input object.
%   
%   This is the machine generated representation of a video input object.
%   This MATLAB code file, CAMERACONFIGCODE.M, was generated from the OBJ2MFILE function.
...
%   type the name of the code file, cameraconfigcode, at the MATLAB command prompt.
%   
%   The code file, CAMERACONFIGCODE.M and its associated MAT-file, CAMERACONFIGCODE.MAT (if
%   it exists) must be on your MATLAB path.
%   
%   Example: 
%       vidobj = cameraconfigcode;
%   
...
try
    MATvar = load('C:\Users\Dell\Documents\Instrinsic Data\10Jan2013\cameraconfigcode');
    MATLoaded = true;
catch
...
% Configure properties whose values are saved in C:\Users\Dell\Documents\Instrinsic Data\10Jan2013\cameraconfigcode.mat.
if (MATLoaded)
